...
public class TeachLogStudentPJOneActivity extends BaseActivity {
	private Button ok;
	...
	private void requestData() {
		...
		map.put("content", 0);
		map.put("type", 3);
		map.put("evaluate", behavior);
		map.put("comment", behaviorNote);
		Log.v("TAG", "student:"+userId+",activity:"+activityId+",evaluate:"+behavior);
		doPost(Config1.getInstance().IP+"activityStudent", map,
				new ResultCallback() {
					@Override
