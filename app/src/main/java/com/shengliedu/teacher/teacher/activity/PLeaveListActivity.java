...
import com.shengliedu.teacher.teacher.adapter.PLeaveListAdapter;
...
public class PLeaveListActivity extends BaseActivity implements OnClickListener {
	private TextView title1;
	private ListView week_plan_list;
	private PLeaveListAdapter pLeaveListAdapter;
	...
	public void initViews() {
		...
		map.put(true, -1);
		final List<ClassRoom> leadClassrooms=MyApplication.userInfo.leadClassrooms;
					...
					new OnClickListener() {
						...
						public void onClick(View arg0) {
							...
							AlertDialog.Builder builder3 = new AlertDialog.Builder(
									PLeaveListActivity.this);
							builder3.setTitle("请假班级");
							// 给对话框设定单选列表项
							int size = leadClassrooms.size();
							String[] classrooms = new String[size];
							for (int i = 0; i < leadClassrooms
									.size(); i++) {
								classrooms[i] = MyApplication.getClassRoomNameForclassroomid(leadClassrooms.get(i).id);
							}
							builder3.setSingleChoiceItems(classrooms, position,
									new AlertDialog.OnClickListener() {
										...
										public void onClick(
												...
												int which) {
											position=which;
											if (leadClassrooms.get(which).id!=classroomId){
												classroomId=leadClassrooms.get(which).id;
												setRightText(MyApplication.getClassRoomNameForclassroomid(classroomId));
												requestData();
											}
											dialog.dismiss();
		...
		pLeaveListAdapter = new PLeaveListAdapter(this, list);
		week_plan_list.setAdapter(pLeaveListAdapter);
		week_plan_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				leave=list.get(arg2);
				Intent intent = new Intent(PLeaveListActivity.this,PLeaveDetailActivity.class);
...
//							// TODO Auto-generated method stub
//							// 教务教研
//							Intent intent = new Intent(PLeaveListActivity.this,
...
//		}
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		}else if (arg0 == 300 && arg1 == 301) {
			if (leave!=null) {
				if (leave.approve!=arg2.getIntExtra("approve", leave.approve)) {
					requestData();
				}
			}
		}
	...
	private Handler handlerReq=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what==1){
				...
				List<Normal> list1 = new ArrayList<Normal>();
				list1 = JSON.parseArray(object.getString("data"),
						Normal.class);
				if (list1 != null) {
					list.clear();
					list.addAll(list1);
					runOnUiThread(new Runnable() {
						@Override
						public void run() {
							pLeaveListAdapter.notifyDataSetChanged();
						}
					});
				}
			}else if (msg.what==2){
	...
	private void requestData() {
		...
		doGet(Config1.getInstance().P_LEAVE_LIST(), map,
				new ResultCallback() {
					@Override
