...
import com.shengliedu.teacher.teacher.adapter.MessageAdapter;
...
public class MessageActivity extends BaseActivity implements OnClickListener {
	...
	public void initViews() {
		...
		week_plan_list.setAdapter(messageAdapter);
		week_plan_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				MessageList message=list.get(arg2);
	...
	private Handler handlerReq=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what==1){
				...
				List<MessageList> list1 = new ArrayList<MessageList>();
	...
	private void requestData() {
		...
		doGet(Config1.getInstance().MESSAGE_LIST(), map,
				new ResultCallback() {
					@Override
