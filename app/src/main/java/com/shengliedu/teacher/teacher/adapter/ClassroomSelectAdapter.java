...
public class ClassroomSelectAdapter extends BaseAdapter {
	...
	public ClassroomSelectAdapter(Context context, List<ClassRoom> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.teach_task_grade_item_text.setText(MyApplication.getClassRoomNameForclassroomid(list.get(position).id));
		return convertView;
	}
