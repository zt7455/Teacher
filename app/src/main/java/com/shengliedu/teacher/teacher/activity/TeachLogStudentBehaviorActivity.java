...
public class TeachLogStudentBehaviorActivity extends BaseActivity {
	...
	public void initViews() {
		...
		if (userId != -1 && userId == MyApplication.userInfo.id) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					Intent intent = new Intent(
							TeachLogStudentBehaviorActivity.this,
							TeachLogStudentPJOneActivity.class);
			...
			t_rel.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent intent = new Intent(
							TeachLogStudentBehaviorActivity.this,
							TeachLogStudentPJALLActivity.class);
					intent.putExtra("activityId", activityId);
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		if (arg0 == 301 && arg1 == 401) {
			behavior = arg2.getIntExtra("behavior", -1);
			String biaoxian = "";
			switch (behavior) {
			case 1:
				biaoxian = "优";
			...
			behaviorNote=arg2.getStringExtra("behaviorNote");
			all_pj.setText(biaoxian);
			setBackSetResult(301);
			allchange=true;
		} else if (arg0 == 301 && arg1 == 402) {
			int behavior = arg2.getIntExtra("behavior", -1);
			String behaviorNote = arg2.getStringExtra("behaviorNote");
			if (behavior != -1) {
				if (person.behavior != behavior) {
					requestData();
				}
				if (behaviorNote != null && !behaviorNote.equals(person.behaviorNote) ) {
					requestData();
				}else if (person.behaviorNote != null && !person.behaviorNote.equals(behaviorNote) ) {
					requestData();
				}
			}
		}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		// TODO Auto-generated method stub
		if (keyCode==KeyEvent.KEYCODE_BACK && allchange) {
			setResult(301);
			finish();
			return false;
		}
	...
	private Handler handlerReq=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what==1){
				List<PersonBean> listarray = JSON.parseArray((String) msg.obj, PersonBean.class);
				data.clear();
