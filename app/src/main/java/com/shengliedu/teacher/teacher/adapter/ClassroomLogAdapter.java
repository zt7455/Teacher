 ...
 * 
 */
public class ClassroomLogAdapter extends BaseAdapter {
	private LayoutInflater layoutInflater;
	private List<TeachLogList> list;

	public ClassroomLogAdapter(Context context, List<TeachLogList> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.teach_log_item_content
				.setText(list.get(position).teach_outline_name);
		String biaoxian = "";
