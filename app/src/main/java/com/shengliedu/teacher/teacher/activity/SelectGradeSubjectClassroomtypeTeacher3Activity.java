...
import com.shengliedu.teacher.teacher.adapter.WeekPlanRight3Adapter;
...
public class SelectGradeSubjectClassroomtypeTeacher3Activity extends BaseActivity {
	...
	private WeekPlanRight3Adapter weekPlanRightAdapter;
	...
	public void getDatas() {
		...
		if (role==1) {
			if (!MyApplication.listIsEmpty(MyApplication.user_grade_Subject_classroomTypes)) {
				...
				weekPlanRightAdapter=new WeekPlanRight3Adapter(this, rightlist);
