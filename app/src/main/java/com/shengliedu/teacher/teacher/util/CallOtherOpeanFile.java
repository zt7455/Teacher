...
//      Intent.createChooser(intent, "请选择对应的软件打开该附件！");   
    ...
    * @since   2015-10-12   zt
    */  
    public void openFileForString(Context context,String url){   
    	try{  
    		Intent intent = new Intent();   
    		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);   
    		//设置intent的Action属性    
    		intent.setAction(Intent.ACTION_VIEW);   
    		//获取文件file的MIME类型    
    		String type = getMIMETypeForString(url);   
    		//设置intent的data和Type属性。    
    		intent.setDataAndType(/*uri*/Uri.parse(url), type);   
    		//跳转    
    		context.startActivity(intent);     
//      Intent.createChooser(intent, "请选择对应的软件打开该附件！");   
    	}catch (ActivityNotFoundException e) {  
   ...
   //根据文件打开
    ...
    //根据文件打开
    public String getMIMETypeForString(String url) {   
