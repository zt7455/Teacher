package com.shengliedu.teacher.teacher.chat.view.expression;
...
public class ExpressionView extends LinearLayout {
	...
	private void setPage(ImageView pageFocused, GridView gridView,
		...
		page1.setImageDrawable(getResources().getDrawable(R.mipmap.dot_nor));
		page2.setImageDrawable(getResources().getDrawable(R.mipmap.dot_nor));
		page3.setImageDrawable(getResources().getDrawable(R.mipmap.dot_nor));
