...
public class TeachLogActivity extends BaseActivity implements OnClickListener {
	...
	public void initViews() {
		...
		week_plan_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(TeachLogActivity.this,TeachLogStudentBehaviorActivity.class);
			...
			setRightText(MyApplication.userInfo.realname,
					new OnClickListener() {
						...
						public void onClick(View arg0) {
							// TODO Auto-generated method stub
							// 教务教研
							Intent intent = new Intent(TeachLogActivity.this,
									SelectGradeSubjectTeacherActivity.class);
							startActivityForResult(intent, 300);
						}
					});
		}
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		if (arg0 == 300 && arg1 == 401) {
			int id = userId;
			userId = arg2.getIntExtra("userId", userId);
			if (userId != id) {
				setRightText(arg2.getStringExtra("userName"));
				requestData();
			}
		} else if (arg0 == 300 && arg1 == 402) {
